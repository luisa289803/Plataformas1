...
import co.com.plataforma1.operaciones.AuditoriaFacade;
...
public class AuditoriaController implements Serializable {
    ...
    @EJB
    private co.com.plataforma1.operaciones.AuditoriaFacade ejbFacade;
    ...
    public Auditoria getAuditoria(java.lang.Integer id) {
