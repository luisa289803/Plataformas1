...
import co.com.plataforma1.operaciones.DocenteFacade;
...
public class DocenteController implements Serializable {
    ...
    @EJB
    private co.com.plataforma1.operaciones.DocenteFacade ejbFacade;
    ...
    public void cargarMaterias(ValueChangeEvent value) {
        docenteSeleccionado = (Docente) value.getNewValue();
        listaMaterias = ejbFacade.obtenerMateriasXDocente(docenteSeleccionado);
    }
}
